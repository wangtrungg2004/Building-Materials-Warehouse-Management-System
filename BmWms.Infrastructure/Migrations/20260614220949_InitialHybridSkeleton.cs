...
{
    /// <inheritdoc />
    public partial class InitialHybridSkeleton : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BalanceID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductID = table.Column<int>(type: "int", nullable: false),
                    StorageLocationCode = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryBalances_ProductID_StorageLocationCode",
                table: "InventoryBalances",
                columns: new[] { "ProductID", "StorageLocationCode" },
                unique: true);
